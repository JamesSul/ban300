...
These next two units are time for you to work on the two DataCamp courses you select as defined in the [project]. If you are using any of the pre-approved topics, you don't need my approval. For anything else, you do. Under no circumstances may you select something from the list of courses you can't use.